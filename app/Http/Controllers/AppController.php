...
class AppController extends Controller{
        ...
        try {
            if ($request->has('loc')):
                ...
                if ($location->stripe_status === 'active' || $location->stripe_status === 'trialing'):
                    ...
                    Alert::success('Thank you', 'Your feedback is invaluable to us.');
    ...
    public function ($inLoc){
        try{
            $loc = Location::select('locations.users_id', 'users.name',  'company', 'email',  'loc_phone', 'support_email', 'locations.status' , 'min_rate', 'stripe_status', 'CID', 'PID'  )
