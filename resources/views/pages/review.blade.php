<x-app-layout>  
    ...
    <x-main-content class="border-2 bg-stone-100" x-data="{shiftPressed: false}"> 
        <div class="flex flex-col items-center justify-center top-0 left-0 ">
            ...
            <div >
                <button type="button"  onclick="doSpinner()" class="px-5 py-4 rounded-xl text-base text-white  btn bg-slate-700 hover:bg-teal-500 mb-4 text-center float-right"      ">
                  Generate Your Review
                </button>    
            </div>
        </div>
        <div id="spinner" class="hidden place-content-center w-1/2 mx-auto my-4 bg-teal-700 px-8 py-4 rounded-lg  z-50" wire:loading>  
