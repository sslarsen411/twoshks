...
<head>
 ...
 {{-- <link href="https://fonts.googleapis.com/css?family=Nunito+Sans:ital,wght@0,200;0,400" rel="stylesheet" /> --}}
 <title>The Rave Review Guru | Two Shakes App</title>
 ...
 <!--[if !mso]><!-- -->
 {{-- <style>
 @font-face { font-family: 'Nunito Sans'; font-style: normal; font-weight: 200; src: url('https://fonts.gstatic.com/s/nunitosans/v15/pe1mMImSLYBIv1o4X1M8ce2xCx3yop4tQpF_MeTm0lfGWVpNn64CL7U8upHZIbMV51Q42ptCp5F5bxqqtQ1yiU4GVilXvVUj.woff') format('woff'), url('https://fonts.gstatic.com/s/nunitosans/v15/pe1mMImSLYBIv1o4X1M8ce2xCx3yop4tQpF_MeTm0lfGWVpNn64CL7U8upHZIbMV51Q42ptCp5F5bxqqtQ1yiU4GVilXvVUl.woff2') format('woff2'); }
 </style>  --}}
</head>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                    <td valign="middle" style=" padding: 0px 0px 60px 0px;">
                        <img src="https://cdn.mojoimpact.com/twoshakes/review-guru-icon.svg"  alt="The Rave Review Guru" style="display: inline; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 160px; height: auto; max-width: 100%; border: 0;" />                        
                    </td>
                    <td valign="middle" style=" padding: 0px 0px 60px 0px;">                         
                   ...
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="left" style="padding: 0px 0px 0px 0px;">
                      <div class="pc-font-alt pc-w620-fontSize-58px" style="line-height: 107%; letter-spacing: -0.2px; font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 62px; font-weight: 200; font-variant-ligatures: normal; color: #000a28; text-align: left; text-align-last: left;">
                       <div><span>Here&#39;s Your Review</span>
                       </div>
                      </div>
                     </td>
                    </tr>
                 ...
                 <tr>
                  <td align="left" valign="top" style="padding: 0px 0px 0px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="left" style="padding: 0px 0px 0px 0px;">
                      <div class="pc-font-alt" style="line-height: 160%; letter-spacing: 0px; font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal; font-variant-ligatures: normal; color: #000a28; text-align: left; text-align-last: left;">
                       <div><span>{{ $first_name }}, here&#39;s a copy of your review for {{ $company }}:</span>
                       </div>                       
                       <div><span></span>
                       </div>
                       <div><span>&#xFEFF;</span>
                       </div>
                       <div style="width: 96%; margin-left: auto; margin-right:auto; background-color:#DEDEDE;"><span>{{ $review }}</span>
                       </div>
                       <div> 
                       </div>
                       <div style="margin-top: 1rem;"><span>Thank you for using the Two Shakes App.</span>
                       </div>
                      </div>
                     </td>
                    </tr>
                 ...
                 <tr>
                  <td align="left" valign="top" style="padding: 0px 0px 20px 0px;">
                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                    <tr>
                     <td valign="top" align="left" style="padding: 0px 0px 0px 0px;">
                      <div class="pc-font-alt" style="line-height: 20px; letter-spacing: -0.2px; font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; font-variant-ligatures: normal; color: #000a28; text-align: left; text-align-last: left;">
                       <div>
                            <img src="https://cdn.mojoimpact.com/twoshakes/new-guru-256.webp"  alt="The Rave Review Guru" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 160px; height: auto; max-width: 100%; border: 0;" />

                        <span>The Rave Review Guru</span>
                       </div>
                      </div>
                     </td>
                    </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border-collapse: separate; border-spacing: 0; margin-right: auto; margin-left: auto;">
                 <tr>
                  <td valign="top" align="left">
                   <div class="pc-font-alt" style="line-height: 24px; letter-spacing: -0.2px; font-family: 'Roboto', Arial, Helvetica, sans-serif; font-size: 14px; font-weight: normal; font-variant-ligatures: normal; color: #000a28; text-decoration: underline; text-align: left; text-align-last: left;">
          ...
          <!-- <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
           <tr>
            <td align="center" valign="top" style="padding-top: 20px; padding-bottom: 20px; vertical-align: top;">
             <a href="https://postcards.email/?uid=MjgxMzg2&type=footer" target="_blank" style="text-decoration: none; overflow: hidden; border-radius: 2px; display: inline-block;">
             ...
             <img src="https://api-postcards.designmodo.com/tracking/mail/promo?uid=MjgxMzg2" width="1" height="1" alt="" style="display:none; width: 1px; height: 1px;">
            </td>
           </tr>
          </table> -->
         </td>
